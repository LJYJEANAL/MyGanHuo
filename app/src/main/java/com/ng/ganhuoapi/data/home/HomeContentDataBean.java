package com.ng.ganhuoapi.data.home;
...
public class HomeContentDataBean   implements Parcelable {

    public static final Creator<HomeContentDataBean   > CREATOR = new Creator<HomeContentDataBean  >() {
        @Override
        public HomeContentDataBean   createFromParcel(Parcel in) {
            return new HomeContentDataBean   (in);
        }

        @Override
        public HomeContentDataBean   [] newArray(int size) {
            return new HomeContentDataBean   [size];
        }
    };
    /**
...
private String videoUrl;
    ...
    public HomeContentDataBean() {
    }

    protected HomeContentDataBean(Parcel in) {
...
//                ", has_m3u8_video=" + has_m3u8_video +
    ...
    public static class MiddleImageBean implements Parcelable{
        /**
