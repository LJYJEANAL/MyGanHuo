...
public class DisplayUtils {
    ...
    public static int px2dp(float pxValue) {
        final float scale = AndroidFactory.getApplicationContext().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        final float scale = AndroidFactory.getApplicationContext().getResources().getDisplayMetrics().scaledDensity;
        return (int) (pxValue / scale + 0.5f);
    }
